...
gaosishangexiangyixing文件是线性对流扩散方程，无源项，各向异性的高斯山扩散，首先也得单位换算，但由于扩散系数是一个矩阵，于是得选取一个物理扩散张量的最大特征值 λ_max_phys来代表扩散强度，并借此计算1单位格子时间代表多少物理时间，高斯山这两个算例均是考虑了周期边界（按照其他文献所说，扩散在边界很小，可以视为周期边界），主要参考的还是文献Huang, Rongzong, and Huiying Wu. 2014. “A Modified Multiple-Relaxation-Time Lattice Boltzmann Model for Convection–Diffusion Equation.” Journal of Computational Physics 274:50–63. https://doi.org/10.1016/j.jcp.2014.05.041.
